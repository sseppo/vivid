> **Status:** historical — family F5; superseded by `docs/context/sources/01-master-vision.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/01_Master_Vision_VIVID_strategyVision_v2.md`. 
...
### A. The "Sagas" vs "Collection" Distinction
