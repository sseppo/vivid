> **Status:** historical — family F6; superseded by `docs/context/sources/02-business-logic-constitution.md`. Kept for provenance; not current. Source: `Visualisatium/planning/02_Business_Logic_Constitution_BusinessLogicEconomics_v6.md`. 
