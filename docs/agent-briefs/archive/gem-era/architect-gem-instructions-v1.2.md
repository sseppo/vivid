> **Status:** retired pre-repository instruction text (Gemini Gem era). Live Gem text; filename typo corrected forward (0 citations); renamed, 0 citation(s). Not a brief any current agent runs on. Source: `vivid/from-gemini/archite4ct-gem-instructions-v1.2.md`. 
