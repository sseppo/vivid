...
| R-41 | 2026-09-19 | ND-13: the owner rotates the Anthropic and OpenAI keys **before the first push**; work continues meanwhile | open until rotated — blocks the push | s6 handoff addendum 2 |
...
| ND-13 | Q12 | Rotate the Anthropic and OpenAI keys held in `valmistelu\legacy-env\`? Deferred to the end of the reorganisation, risk accepted (R-20) | **open** — owner rotates before the first push | R-41 |
