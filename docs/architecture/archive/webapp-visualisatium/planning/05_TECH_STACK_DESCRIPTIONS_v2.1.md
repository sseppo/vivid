> **Status:** historical — family F9; superseded by `docs/architecture/tech-stack-descriptions.md`. Kept for provenance; not current. Source: `Visualisatium/planning/05_TECH_STACK_DESCRIPTIONS_v2.1.md`. 
