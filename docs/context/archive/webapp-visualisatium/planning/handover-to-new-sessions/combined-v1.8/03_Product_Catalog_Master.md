> **Status:** historical — family F7; superseded by `docs/context/sources/03-product-catalog.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/combined-v1.8/03_Product_Catalog_Master.md`. 
...
> **Source:** `Odyssey_Product_Line.md`
...
> **Source:** `Smart_Collections_Logic_v1.0.md` & `Odyssey_Product_Line.md`
