> **Status:** historical — family F12; superseded by `docs/context/sources/07-features-ux.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/07_Features_UX_Master_v2.md`. 
...
## 11. SPECS: CHARACTER PERSISTENCE ENGINE ("The Vault")
...
### 1. OBJECTIVE
When a user buys a "Mascot" today, they must be able to use the *exact same* mascot in a video next week without re-prompting or getting random variations.
