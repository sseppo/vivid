> **Status:** historical — family F11; superseded by `docs/context/sources/06-partner-ecosystem.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/06_Partner_Ecosystem_Master.md`. 
...
**Requirement:** The Partner **SHOULD** upload the resulting digital files to the User's "Visualisatium Vault" (R2 Bucket). This is the "Hook" for our editing services.

---

## 1. THE PARTNER MODEL: "THE UNLOCK PROTOCOL"
> **Source:** `Partner_Logic_v1.0.md` & `Partner_Ecosystem_Logic.md`
...
> **Source:** `Partner_Royalty_Model.md`
...
> **Source:** `visualisatium-improvements_chat_v1.md`
...
### The "Loop-Back" (Printers)
* **The Asset:** Partner prints a physical canvas/book.
* **The Label:** Partner sticks a QR code on the back: `visualisatium.com/p/reorder?id=123`.
* **The Pitch:** "Scan to animate this photo."
...
* **Split:** The 20% Premium goes *directly* to the IP Holder.
* **Benefit:**
...
> **Source:** `Partner_Dashboard_Addendum.md`
