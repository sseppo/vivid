> **Status:** current edition (F7, newest). A fuller earlier edition is at `docs/context/sources/03-product-catalog-fullest-edition.md`; later revisions lost content to Gem context limits. Reconciliation is Architect work. Source: `vivid/.chat_attachments/start/03_Product_Catalog_Master_v5.md`. 
...
7.  **"The Digital Person Evolution"** (Data -> Training -> Chat)
...
18. **THE "CHILD'S IMAGINATION" TOY**
    * **Target:** Parents.
    * **Flow (2 Steps):**
...
19. **THE "MEDITATION GUIDE" (Personalized)**
    * **Target:** Wellness.
    * **Flow:**
...
**Strategy:** We treat "Recipes" as **Micro-Products** or Unlockables.
