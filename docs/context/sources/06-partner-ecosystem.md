> **Status:** current edition (F11, newest). A fuller earlier edition is at `docs/context/sources/06-partner-ecosystem-fullest-edition.md`; later revisions lost content to Gem context limits. Reconciliation is Architect work. Source: `vivid/.chat_attachments/start/06_Partner_Ecosystem_Master_v4.md`. 
...
Followng A1 and A2 are mutually exclusive states for a specific partner (A partner is either Verified or Not).
...
### C. Liability Shield
* **The "Yellow Line" Rule:** Liability for physical goods remains with the Partner. The UI clearly delineates where Vivid ends and Partner begins.
...
## 2. THE "ROYALTY" MODEL (Affiliate Model)
**Concept:** Turn Partners from "Vendors" into "Affiliates.". The Growth Hack.
...
## 4. THE IP PARTNER PROGRAM ("OFFICIAL WORLDS")
