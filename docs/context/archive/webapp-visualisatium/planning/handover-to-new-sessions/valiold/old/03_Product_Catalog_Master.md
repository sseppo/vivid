> **Status:** historical — family F7; superseded by `docs/context/sources/03-product-catalog.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/03_Product_Catalog_Master.md`. 
