> **Status:** historical — family F12; superseded by `docs/context/sources/07-features-ux.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/07_Features_UX_Master_v4.md`. 
