> **Status:** fuller earlier edition — content lost to Gem context limits in later revisions, not superseded in substance. Current edition: `docs/context/sources/02-business-logic-constitution.md`. Reconciliation is Architect work. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/02_Business_Logic_Constitution_BusinessLogicEconomics_v6_v2.md`. 
...
| Variable Name | Cost (Euros) | Definition |
| :--- | :--- | :--- |
