> **Status:** historical — family F6; superseded by `docs/context/sources/02-business-logic-constitution.md`. Kept for provenance; not current. Source: `Visualisatium/planning/handover-to-new-sessions/valiold/old/02_Business_Logic_Constitution_BusinessLogicEconomics_v6_v3.md`. 
...
To avoid "Hardcoded Chaos," all logic references these variables. Actual values are derived from `pricing-plan-vivid-v1` and `PricingTable`. Following is just an example.
...
4.  **Re-Roll Cost (The "Computing Fee"):**
    * User pays **much smaller amount of Credits (e.g. 1/5)** to generate 4 new previews.
...
---
## 18. THE ABANDONMENT & RESTORATION PROTOCOL ("Phoenix")
...
## 20. SPECS: THE SMART LEDGER (Economic Engine)
